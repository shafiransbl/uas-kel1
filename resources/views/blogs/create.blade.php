...
<body class="bg-gray-100">
    <div class="container py-5">
        ...
        <form action="{{ route('blogs.store') }}" method="POST" enctype="multipart/form-data" class="row g-4">
            @csrf
            ...
            <div class="col-md-4 bg-white p-4 rounded-lg shadow-sm order-2 order-md-3">
                ...
                <button type="submit" 
                    class="w-full px-6 py-3 rounded-full bg-teal-400 text-white font-bold hover:bg-teal-500">Create Blog</button>
            </div>
        </form>
    </div>
</body>
